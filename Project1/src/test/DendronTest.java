...
public class DendronTest {
    ...
    private static List< List< String > > programs = Arrays.asList(
            ...
            new LinkedList<>( Arrays.asList( "@", "/", "5", "0" ) ), // Division by zero
            new LinkedList<>( Arrays.asList( ":=", "42", "+", "5", "0" ) ),  // Uninitialized variable
            new LinkedList<>( Arrays.asList( "@", "abracadabra" ) ),  // Uninitialized variable (not in symbol table)
            new LinkedList<>( Arrays.asList( ":=", "x", "9", "+", "7", "9" ) ),  // Extra tokens
            new LinkedList<>( Arrays.asList( ":=", "x", "9", ":=" ) ), // Premature End
            new LinkedList<>( Arrays.asList( ":=", "y" ) ),  // Uninitialized variable
            new LinkedList<>( Arrays.asList( ":=", "x", "9", "@" ) ),  // Premature End

            // Additional Errors used for testing
            new LinkedList<>( Arrays.asList( ":=", "x", "9", "value3", "+", "7", "9" ) ),  // Extra tokens
            new LinkedList<>( Arrays.asList( ":=", "x", "9", "^", "+", "7", "9" ) ),   // Invalid character "^"
            new LinkedList<>( Arrays.asList( ":=", "x", "1", "@", "@", "+", "7", "9" ) )  // Duplicate print tokens
    );
