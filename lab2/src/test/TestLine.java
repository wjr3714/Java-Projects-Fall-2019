...
public class TestLine {
    ...
    public void testBadHoriLines1() {
        new Line(new Dot(0,1), new Dot(0, 0));
    }

    @Test(expected=AssertionError.class)
    public void testBadHoriLines2() {
        new Line(new Dot(0,1), new Dot(0, 0));
    }

    @Test(expected=AssertionError.class)
    public void testBadVertLines1() {
        new Line(new Dot(1, 0), new Dot(0, 0));
    }

    @Test(expected=AssertionError.class)
    public void testBadVertLines2() {
    ...
    public static void allDone() {
        System.out.println( TestLine.class.getSimpleName() + " All done.");
    }
