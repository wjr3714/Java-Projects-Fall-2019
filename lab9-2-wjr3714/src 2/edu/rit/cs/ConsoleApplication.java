 ...
 * {@link #go(Scanner, PrintWriter)} (Scanner, PrintWriter) start} method returns,
 * {@link #stop() stop} is executed.
 *
...
public abstract class ConsoleApplication {
    ...
    public static void launch(
        ...
        try {
            ConsoleApplication ptuiApp =
                  //ConsoleAppliction.newInstance( ptuiClass);
                  ptuiClass.getDeclaredConstructor().newInstance();
     ...
     * the JavaFX Application.start(Stage) method
